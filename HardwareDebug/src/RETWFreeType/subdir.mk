...
src/RETWFreeType/%.o: ../src/RETWFreeType/%.src
	...
	@echo arm-none-eabi-as -I"C:\Workspace\RZ\RZ_A1H_OpenVG_RSK/src" -I"C:\Workspace\RZ\RZ_A1H_OpenVG_RSK\bin" -adlhn="$(basename $(notdir $<)).lis" --gdwarf2 -mlittle-endian -mcpu=cortex-a9 -march=armv7-a -mthumb-interwork -mfloat-abi=hard -mfpu=vfp -o"$@" "$<"
	@echo 'Finished building: $<'
	@echo.
