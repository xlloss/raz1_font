...
src/drivers/adc/%.o: ../src/drivers/adc/%.c
	@echo 'Scanning and building file: $<'
	@echo 'Invoking: Scanner and Compiler'
	@arm-none-eabi-gcc -MM -MP -MF ""$(@:%.o=%.d)"" -MT"$(@:%.o=%.o)" -MT""$(@:%.o=%.d)"" @"src/drivers/adc/c.depsub" "$<"
	...
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/drivers/adc/c.sub" -o "$(@:%.d=%.o)" "$<"
