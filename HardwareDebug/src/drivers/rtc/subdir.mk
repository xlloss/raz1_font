...
src/drivers/rtc/%.o: ../src/drivers/rtc/%.c
	...
	@arm-none-eabi-gcc -MM -MP -MF ""$(@:%.o=%.d)"" -MT"$(@:%.o=%.o)" -MT""$(@:%.o=%.d)"" @"src/drivers/rtc/c.depsub" "$<"
	...
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/drivers/rtc/c.sub" -o "$(@:%.d=%.o)" "$<"
