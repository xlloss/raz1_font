...
#if (  SYSTEM_DISPLAY==SYSdef_DSP_1280480 )

//												percent,B,G,R,alpha								percent,B,G,R,alpha								percent,B,G,R,alpha
#define				VG_DSP_SizeX		Screen_SizeX
#define				VG_DSP_SizeY		Screen_SizeY
#define				VG_DSP_CenterX	640
#define				VG_DSP_CenterY	240
...
#define 		MSStep7			(500)						//Wait for 2 fps at least
#define 		MSStep8			(500)						 
#define 		MSStep9			(200)						 
#define 		MSStepA			(200)						 
...
#define 		SWMStep2 			(500)						//Rotate 3 meters		, this is wait only.	
#define 		SWMStep3			(500)						//Return 3 meters
...
// 		RETW_GUI_PoliconFillScreen(0,0,VG_DSP_SizeX,VG_DSP_SizeY,0xFFFF00ff);	
//    return;
 			
//Show Renesas Logo 
   	if(Milisec_ModeEntry < MotionUpto1)
   	{
							RETW_GUI_PoliconFillScreen(0,0,VG_DSP_SizeX,VG_DSP_SizeY,0xFFFFFFFF);	
							RETW_GUI_OPENMOTION_0_Mobj_Initial(0);
							
							vgFinish();
							DspBMP(_RUS_ADDR, (VG_DSP_SizeX-404)/2,(VG_DSP_SizeY-68)/2, VG_Back_FrameBuffer, 0,0);
							DspBMP(_RZS_ADDR, (VG_DSP_SizeX-114)/2,(VG_DSP_SizeY-40)/2 + 100, VG_Back_FrameBuffer, 0,0);	
...
//Right Gear RZ/A1H Enlarge/Shrinked
		else if(Milisec_ModeEntry < MotionUpto2)																			 
			{
							...
							RETW_GUI_PoliconFillScreen(0,0,VG_DSP_SizeX,VG_DSP_SizeY,MOTIONBackColor);	
						
						if((Milisec_ModeEntry-MotionUpto1) < (MSStep2/2) )
							{
 								MeterObj[1].CenterX=VG_DSP_CenterX;
 								MeterObj[1].CenterY=VG_DSP_CenterY;
							...
							{
 								//moving to (234,240)
 								MeterObj[1].CenterX=234+ (640-234) * (MSStep2-(Milisec_ModeEntry-MotionUpto1))/(MSStep2/2);						//getting smaller
...
//Two gear rotation	 
 		...
 		{
						RETW_GUI_PoliconFillScreen(0,0,1280,480,MOTIONBackColor);	
						vgFinish();
...
//Four meter move to left and right 4 corner
		...
		else if(Milisec_ModeEntry < MotionUpto5)																 
 		{
					...
					{
 						MeterObj[1].CenterX=VG_DSP_CenterX - (VG_DSP_CenterX-100) * sin( PI*MotionSpeedF/2880/2); 
 						MeterObj[1].CenterY=0 + (VG_DSP_SizeY-100) * sin( PI*MotionSpeedF/2880/2); 
						MeterObj[1].O1Outer = 200 * sin( PI*MotionSpeedF/2880/2); 
//					MeterObj[1].AngleShift =  1440 * sin( PI*MotionSpeedF/2880/2); 
						
 						MeterObj[2].CenterX=VG_DSP_CenterX + (VG_DSP_CenterX-100) * sin( PI*MotionSpeedF/2880/2); 
 						MeterObj[2].CenterY=0 + (VG_DSP_SizeY-100) * sin( PI*MotionSpeedF/2880/2); 
						MeterObj[2].O1Outer = 200 * sin( PI*MotionSpeedF/2880/2); 
//					MeterObj[2].AngleShift =  1440 * sin( PI*MotionSpeedF/2880/2); 
								
 						MeterObj[3].CenterX=VG_DSP_CenterX - (VG_DSP_CenterX-100) * sin( PI*MotionSpeedF/2880/2); 
...
//					MeterObj[3].AngleShift =  1440 * sin( PI*MotionSpeedF/2880/2); 
 						...
 						MeterObj[4].CenterX=VG_DSP_CenterX + (VG_DSP_CenterX-100) * sin( PI*MotionSpeedF/2880/2); 
...
// 				ClockCenterY=240; 			
 				...
 				MeterObj[0].CenterX = VG_DSP_CenterX;
 				MeterObj[0].CenterY = VG_DSP_CenterY + 180 * sin( PI* (Milisec_ModeEntry-MotionUpto5)/MSStep6); 			
...
//will make fps less than 60
 				...
 				MeterObj[0].CenterX = VG_DSP_CenterX;
 				MeterObj[0].CenterY = VG_DSP_CenterY;
	  ...
	  else
	  {
 			if( MainMeterChange>0)
 			{
 				RETW_GUI_OM_ROTATE_METER_POS(CurrentMainMeter);
			}
			else
			{
 				if(ModeEntryCnt<5)
 				{
						RETW_GUI_PoliconFillScreen(0,0,VG_DSP_CenterX,VG_DSP_CenterY,MOTIONBackColor);	
      			RETW_GUI_OM_FRAME_METAL( 1 );
      			RETW_GUI_OM_FRAME_METAL( 2 );
      			RETW_GUI_OM_FRAME_CIRCLE( 3 );
      			RETW_GUI_OM_FRAME_METAL( 4 );
...
}				//Endof RETW_GUI_OPENMOTION_0()

void RETW_GUI_OM_ROTATE_METER_POS()
{
...
//   			printf("Enter SWMUpto1-1\n");
				MotionSpeedF = (2880)*Milisec_SWMeterEntry/(SWMStep1);
 				...
 				MeterObj[swtomode].CenterX=  100 + (VG_DSP_CenterX-100) * sin( PI*MotionSpeedF/2880/2); 
 				MeterObj[swtomode].CenterY=  (VG_DSP_SizeY-100) - (VG_DSP_CenterY-100) * sin( PI*MotionSpeedF/2880/2); 
				MeterObj[swtomode].O1Outer = 200 +(470-200)  * sin( PI*MotionSpeedF/2880/2); 
 				...
 				MeterObj[swtomode].CenterX= (VG_DSP_SizeX-100) - ((VG_DSP_SizeX-100)-100) * sin( PI*MotionSpeedF/2880/2); 
 				MeterObj[swtomode].CenterY= (VG_DSP_SizeY-100);
				MeterObj[swtomode].O1Outer = 200;
 				...
 				MeterObj[swtomode].CenterX= (VG_DSP_SizeX/2) + ((VG_DSP_SizeX-100)-(VG_DSP_SizeX/2)) * sin( PI*MotionSpeedF/2880/2); 
 				MeterObj[swtomode].CenterY= VG_DSP_CenterY + (VG_DSP_CenterY-100) * sin( PI*MotionSpeedF/2880/2); 
...
void RETW_GUI_OPENMOTION_0_FlashSignClean()
{
   				...
   				RETW_GUI_PoliconFillScreen(80-(SignSizeX/2), VG_DSP_CenterY-(SignSizeY/2),	SignSizeX,SignSizeY, MOTIONBackColor);	
   				RETW_GUI_PoliconFillScreen(VG_DSP_SizeX-80-(SignSizeX/2), VG_DSP_CenterY-(SignSizeY/2),	SignSizeX,SignSizeY, MOTIONBackColor);		
   				RETW_GUI_PoliconFillScreen(0,0,VG_DSP_SizeY,16, MOTIONBackColor);	
}
...
//Right DIRECTION sign
						...
						if( Milisec_SignFlashCount<80 )
   							RETW_GUI_PoliconFillScreen(VG_DSP_SizeX-80-(SignSizeX/2), 				VG_DSP_CenterY-(SignSizeY/2),	12,SignSizeY,0x109010ff);	
   							
   					else if ( Milisec_SignFlashCount<160 )
   						{
   							RETW_GUI_PoliconFillScreen(VG_DSP_SizeX-80-(SignSizeX/2), 				VG_DSP_CenterY-(SignSizeY/2),	12,SignSizeY,0x109010ff);	
   							RETW_GUI_PoliconFillScreen(VG_DSP_SizeX-80-(SignSizeX/2)+20, 		VG_DSP_CenterY-(SignSizeY/2),	14,SignSizeY,0x10B010ff);	   							   					
   						}
   					else if ( Milisec_SignFlashCount<240 )
   						{
   							RETW_GUI_PoliconFillScreen(VG_DSP_SizeX-80-(SignSizeX/2), 				VG_DSP_CenterY-(SignSizeY/2),	12,SignSizeY,0x109010ff);	
   							RETW_GUI_PoliconFillScreen(VG_DSP_SizeX-80-(SignSizeX/2)+20, 		VG_DSP_CenterY-(SignSizeY/2),	14,SignSizeY,0x10B010ff);	 
   							RETW_GUI_PoliconFillScreen(VG_DSP_SizeX-80-(SignSizeX/2)+40, 		VG_DSP_CenterY-(SignSizeY/2),	16,SignSizeY,0x10D010ff);	  							   					
   						}
   					else if ( Milisec_SignFlashCount<320 )
   						{
   							...
   							RETW_GUI_PoliconFillScreen(VG_DSP_SizeX-80-(SignSizeX/2)+20, 		VG_DSP_CenterY-(SignSizeY/2),	14,SignSizeY,0x10B010ff);	 
   							RETW_GUI_PoliconFillScreen(VG_DSP_SizeX-80-(SignSizeX/2)+40, 		VG_DSP_CenterY-(SignSizeY/2),	16,SignSizeY,0x10D010ff);	
   							RETW_GUI_PoliconFillScreen(VG_DSP_SizeX-80-(SignSizeX/2)+60, 		VG_DSP_CenterY-(SignSizeY/2),	18,SignSizeY,0x10FF10ff);	 	   							   					
   						}
   					else  
   						{
   							RETW_GUI_PoliconFillScreen(VG_DSP_SizeX-80-(SignSizeX/2), 				VG_DSP_CenterY-(SignSizeY/2),	12,SignSizeY,0x109010ff);	
   							...
   							RETW_GUI_PoliconFillScreen(VG_DSP_SizeX-80-(SignSizeX/2)+60, 		VG_DSP_CenterY-(SignSizeY/2),	18,SignSizeY,0x10FF10ff);	 	 					
								...
								CenterX = VG_DSP_SizeX-80-(SignSizeX/2)+80+ 32;
								CenterY = VG_DSP_CenterY;
...
//Left DIRECTION sign
						...
						if( Milisec_SignFlashCount<80 )
   							RETW_GUI_PoliconFillScreen(80+(SignSizeX/2)-20+8, 		VG_DSP_CenterY-(SignSizeY/2),	12,SignSizeY,0x109010ff);	
   							
   					else if ( Milisec_SignFlashCount<160 )
   						{
   							RETW_GUI_PoliconFillScreen(80+(SignSizeX/2)-20+8, 		VG_DSP_CenterY-(SignSizeY/2),	12,SignSizeY,0x109010ff);	
   							RETW_GUI_PoliconFillScreen(80+(SignSizeX/2)-40+6, 		VG_DSP_CenterY-(SignSizeY/2),	14,SignSizeY,0x10B010ff);	  							   					
   						}
   					else if ( Milisec_SignFlashCount<240 )
   						{
   							RETW_GUI_PoliconFillScreen(80+(SignSizeX/2)-20+8, 		VG_DSP_CenterY-(SignSizeY/2),	12,SignSizeY,0x109010ff);	
   							RETW_GUI_PoliconFillScreen(80+(SignSizeX/2)-40+6, 		VG_DSP_CenterY-(SignSizeY/2),	14,SignSizeY,0x10B010ff);	 
   							RETW_GUI_PoliconFillScreen(80+(SignSizeX/2)-60+4, 		VG_DSP_CenterY-(SignSizeY/2),	16,SignSizeY,0x10D010ff);	  							   					
   						}
   					else if ( Milisec_SignFlashCount<320 )
   						{
   							RETW_GUI_PoliconFillScreen(80+(SignSizeX/2)-20+8, 		VG_DSP_CenterY-(SignSizeY/2),	12,SignSizeY,0x109010ff);	
   							RETW_GUI_PoliconFillScreen(80+(SignSizeX/2)-40+6, 		VG_DSP_CenterY-(SignSizeY/2),	14,SignSizeY,0x10B010ff);	 
   							RETW_GUI_PoliconFillScreen(80+(SignSizeX/2)-60+4, 		VG_DSP_CenterY-(SignSizeY/2),	16,SignSizeY,0x10D010ff);	
   							RETW_GUI_PoliconFillScreen(80+(SignSizeX/2)-80+2, 		VG_DSP_CenterY-(SignSizeY/2),	18,SignSizeY,0x10FF10ff);   							   					
   						}
   					else  
   						{
   							RETW_GUI_PoliconFillScreen(80+(SignSizeX/2)-20+8, 		VG_DSP_CenterY-(SignSizeY/2),	12,SignSizeY,0x109010ff);	
...
#endif			/*end of (SYSTEM_DISPLAY==SYSdef_DSP_1280480)	*/