...
#if     (LCD_VDC5_CH0_PANEL==LCD_CH0_PANEL_HDMI_400x1280)
...
{
    (uint16_t)(LCD_DISP_S_VSYNC ),       /* Signal pulse start position */
...
{
    (uint16_t)( LCD_DISP_S_HSYNC ),              /* Signal pulse start position */
    (uint16_t)( LCD_DISP_W_HSYNC ),              /* Pulse width */
    VDC5_LCD_TCON_POLMD_NORMAL,
...
{
    ( uint16_t )LCD_CH0_DISP_HS*2,              /* Signal pulse start position */
    ( uint16_t )LCD_CH0_DISP_HW*2,              /* Pulse width */
    VDC5_LCD_TCON_POLMD_NORMAL,         /* Signal generation mode select */
    ( uint16_t )0,                        /* Signal operating reference select */
    ( uint16_t )0,                        /* Polarity inversion control of signal */
    VDC5_LCD_TCON_PIN_NON,              /* Output pin for LCD driving signal */
