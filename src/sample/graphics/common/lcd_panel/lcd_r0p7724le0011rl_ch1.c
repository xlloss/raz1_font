...
*******************************************************************************/
/**************************************************************************//**
* @file         lcd_r0p7724le0011rl_ch1.c
* @version      0.11
* $Rev: 2444 $
...
#if     (LCD_VDC5_CH1_PANEL==3)

/******************************************************************************
Macro definitions
******************************************************************************/
/* Port 4 */
#define LCD_PORT4_2ND (0x1400u)
/* Port 5 */
...
void GRAPHICS_SetLcdPanel_Ch1 (void)
{
    ...
    /*  R0P7724LE0011RL (RGB666)
            LCDDCK      : LCD1_CLK              ... P4_12, 2nd alternative function
            LCDDISP     : LCD1_TCON5            ... P4_10, 2nd alternative function
        LCD1_DATA
            R[5:0]      : LCD1_DATA[17:16]      ... P5_10 ~ P5_9, 7th alternative function
                        :          [15:12]      ... P2_15 ~ P2_12, 7th alternative function
            G[5:0]      : LCD1_DATA[11:8]       ... P2_11 ~ P2_8, 6th alternative function
                        :          [7:6]        ... P5_7 ~ P5_6, 2nd alternative function
...
{
    /* R0P7724LE0011RL (RGB666), WVGA 800x480 */
...
#endif  /* LCD_VDC5_CH1_PANEL==LCD_CH1_PANEL_R0P7724LE0011RL */
