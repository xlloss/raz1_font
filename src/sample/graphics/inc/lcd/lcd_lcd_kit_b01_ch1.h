...
#ifndef LCD_LCD_KIT_B01_CH1_H
#define LCD_LCD_KIT_B01_CH1_H
...
/* Option board (part number: RTK7721000B00000BR)
    LCD-KIT-B01 (RGB666), J12
    WVGA 800x480 */
#define     LCD_CH1_DISP_HS         (128u)                      /* LCD display area size, horizontal start position */
