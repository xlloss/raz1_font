...
#define     LCD_1280XGA_H_VISIBLE_AREA      (400u)                     /* Horizontal visible area [pixel] */
...
#define     LCD_1280XGA_V_VISIBLE_AREA      (1280u)                      /* Vertical visible area [line] */
...
#define     LCD_CH0_S_HSYNC         (5u)                        /* Hsync start position */
...
#define     LCD_CH0_S_VSYNC         (10u)                        /* Vsync start position */
...
#define     LCD_CH0_PANEL_CLK       VDC5_PANEL_ICKSEL_PERI		//VDC5_PANEL_ICKSEL_LVDS      /* Panel clock select */
#define     LCD_CH0_PANEL_CLK_DIV   VDC5_PANEL_CLKDIV_1_1       /* Panel clock frequency division ratio */

#define     LCD_CH0_TCON_HALF       (LCD_CH0_SIG_FH /2 )       	/* TCON reference timing, 1/2fH timing */
