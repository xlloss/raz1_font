...
/* RSK board
    LCD-HDMI
    WVGA 800x480 */
#define     LCD_CH0_DISP_HS         (300u)                      /* LCD display area size, horizontal start position */
#define     LCD_CH0_DISP_HW         (1280u)                      /* LCD display area size, horizontal width */
//#define     LCD_DISP_S_HSYNC        (1344u)
//#define     LCD_DISP_W_HSYNC        (320u)

#define     LCD_CH0_DISP_VS         (60u)                       /* LCD display area size, vertical start position */
...
#define     LCD_CH0_SIG_FV          (540u - 1u)                 /* Free-running Vsync period */
#define     LCD_CH0_SIG_FH          (1580u - 1u)                /* Hsync period */
