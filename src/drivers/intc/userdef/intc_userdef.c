...
*              : when an unsupported interrupt ID is received. If this function
*              : is called when the int_id shows "0x3FF(=1023)", the software may
*              : not have properly cleared the interrupt source of the level 
*              : sense previously received. Refer to the descriptions for the 
*              : ICCIAR register included in the document regarding to ARM GIC 
*              : architecture.
* Arguments    : uint16_t int_id    : Interrupt ID
* Return Value : none
******************************************************************************/
