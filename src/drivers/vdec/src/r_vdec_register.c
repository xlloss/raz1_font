...
/**************************************************************************//**
 * @brief       Setting registers for input pin
 * @param[in]   ch                      : Channel
...
/**************************************************************************//**
 * @brief       Setting registers for active image period
 * @param[in]   ch                      : Channel
...
/**************************************************************************//**
 * @brief       Setting registers for sync separation
 * @param[in]   ch                      : Channel
...
/**************************************************************************//**
 * @brief       Setting registers for Y/C separation
 * @param[in]   ch                      : Channel
...
/**************************************************************************//**
 * @brief       Setting registers for chroma decoding
 * @param[in]   ch                      : Channel
...
/**************************************************************************//**
 * @brief       Setting registers for digital clamp
 * @param[in]   ch                      : Channel
...
void VDEC_DigitalClamp (const vdec_channel_t ch, const vdec_degital_clamp_t * const param)
{
    ...
    *(vdec_reg->dcpcr6) = (uint16_t)((uint32_t)param->dcpwidth << VEDC_REG_SHIFT_8);
    ...
    if (p_pedestal_clamp != NULL)
    {
        ...
        reg_data   |= (p_pedestal_clamp->dcpmode_y == VDEC_DCPMODE_MANUAL) ? (uint32_t)0x0000u : (uint32_t)VDEC_REG_SET_0X8000;
    ...
    {
        /* Clamp level setting mode */
        reg_data    = (p_center_clamp->dcpmode_c == VDEC_DCPMODE_MANUAL) ? (uint32_t)0x0000u : (uint32_t)VDEC_REG_SET_0X8000;
...
/**************************************************************************//**
 * @brief       Setting registers for output adjustment
 * @param[in]   ch                      : Channel
...
/**************************************************************************//**
 * @brief       Querying for VDEC parameters
 * @param[in]   ch                      : Channel
    ...
    vdec_q_digital_clamp_t  * const q_digital_clamp)
{
    ...
    if (q_sync_sep != NULL)
    {
        ...
        q_sync_sep->fhmode = ((reg_value & (uint32_t)VDEC_REG_BIT_MASK_0X1000) == 0u) ? VDEC_FHMD_NORMAL : VDEC_FHMD_MULTIPLIED;
        ...
        q_sync_sep->fvmode = ((reg_value & (uint32_t)VDEC_REG_BIT_MASK_0X0200) == 0u) ? VDEC_FVMD_50HZ : VDEC_FVMD_60HZ;
    ...
    if (q_agc != NULL)
    {
        ...
        /* Number of pixels which have larger luminance value than peak luminance */
    ...
    if (q_chroma_dec != NULL)
    {
        ...
        q_chroma_dec->fscmode = ((reg_value & (uint32_t)VDEC_REG_BIT_MASK_0X2000) == 0u) ? VDEC_FSCMD_3_58 : VDEC_FSCMD_4_43;
        ...
        q_chroma_dec->accsubgain = (vdec_chrm_subgain_t)((reg_value >> VEDC_REG_SHIFT_9) & (uint32_t)VDEC_REG_MASK_0X0003);
...
/**************************************************************************//**
 * @brief       Setting registers for noise reduction LPF
 * @param[in]   vdec_reg                : VDEC registers
 * @param[in]   p_noise_rd_lpf          : Noise reduction LPF parameters
 * @retval      none
 *****************************************************************************/
static void NoiseReductionLPF (
    const vdec_reg_address_t    * const vdec_reg,
...
/**************************************************************************//**
 * @brief       Setting registers for sync slicer
 * @param[in]   vdec_reg                : VDEC registers
 * @param[in]   p_sync_slicer           : Sync slicer parameters
 * @retval      none
 *****************************************************************************/
static void SyncSlicer (const vdec_reg_address_t * const vdec_reg, const vdec_sync_slicer_t * const p_sync_slicer)
{
...
/**************************************************************************//**
 * @brief       Setting registers for horizontal AFC
 * @param[in]   vdec_reg                : VDEC registers
 * @param[in]   p_horizontal_afc        : Horizontal AFC parameters
 * @retval      none
 *****************************************************************************/
static void HorizontalAFC (
    const vdec_reg_address_t    * const vdec_reg,
...
/**************************************************************************//**
 * @brief       Setting registers for vertical countdown
 * @param[in]   vdec_reg                : VDEC registers
 * @param[in]   p_vcount_down           : Vertical countdown parameters
 * @retval      none
 *****************************************************************************/
static void VerticalCountdown (
    const vdec_reg_address_t    * const vdec_reg,
...
/**************************************************************************//**
 * @brief       Setting registers for AGC / PGA
 * @param[in]   vdec_reg                : VDEC registers
 * @param[in]   p_agc                   : AGC / PGA parameters
 * @retval      none
 *****************************************************************************/
static void AgcPga (const vdec_reg_address_t * const vdec_reg, const vdec_agc_t * const p_agc)
{
    ...
    if (p_agc != NULL)
    {
        /* A/D converter AGC ON/OFF control & PGA gain select */
...
/**************************************************************************//**
 * @brief       Setting registers for peak limiter control
 * @param[in]   vdec_reg                : VDEC registers
 * @param[in]   p_peak_limiter          : Peak limiter control parameters
 * @retval      none
 *****************************************************************************/
static void PeakLimiterControl (
    const vdec_reg_address_t    * const vdec_reg,
...
/**************************************************************************//**
 * @brief       Setting registers for Over-range control
 * @param[in]   vdec_reg                : VDEC registers
 * @param[in]   p_over_range            : Over-range control parameters
 * @retval      none
 *****************************************************************************/
static void OverRangeControl (const vdec_reg_address_t * const vdec_reg, const vdec_over_range_t * const p_over_range)
{
...
/**************************************************************************//**
 * @brief       Setting registers for Y/C separation control
 * @param[in]   vdec_reg                : VDEC registers
 * @param[in]   p_yc_sep_ctrl           : Y/C separation control parameters
 * @retval      none
 *****************************************************************************/
static void YcSeparationControl (
    const vdec_reg_address_t    * const vdec_reg,
    const vdec_yc_sep_ctrl_t    * const p_yc_sep_ctrl)
{
    ...
    if (p_yc_sep_ctrl != NULL)
    {
        ...
        *(vdec_reg->ycscr7) = (uint16_t)reg_data;
        ...
        reg_data   |= (p_yc_sep_ctrl->hbpf_narrow == VDEC_LSTG_BPFSEL_BYPASS) ? (uint32_t)0x0000u : (uint32_t)VDEC_REG_SET_0X8000;
        /* Latter-stage horizontal/vertical BPF select */
        reg_data   |= (p_yc_sep_ctrl->hvbpf_narrow == VDEC_LSTG_BPFSEL_BYPASS) ? (uint32_t)0x0000u : (uint32_t)VDEC_REG_SET_0X4000;
        /* Former-stage horizontal BPF select */
        reg_data   |= (p_yc_sep_ctrl->hbpf1_9tap_on == VDEC_FSTG_BPFSEL_17TAP) ? (uint32_t)0x0000u : (uint32_t)VDEC_REG_SET_0X2000;
        /* Former-stage horizontal/vertical BPF select */
        reg_data   |= (p_yc_sep_ctrl->hvbpf1_9tap_on == VDEC_FSTG_BPFSEL_17TAP) ? (uint32_t)0x0000u : (uint32_t)VDEC_REG_SET_0X1000;
        /* Horizontal filter and horizontal/vertical filter bandwidth switch signal */
        reg_data   |= (p_yc_sep_ctrl->hfil_tap_sel == VDEC_HFIL_TAP_SEL_17TAP) ? (uint32_t)0x0000u : (uint32_t)VDEC_REG_SET_0X0800;
        ...
        *(vdec_reg->ycscr11) = (uint16_t)reg_data;
        ...
        reg_data   |= (p_yc_sep_ctrl->fil2_narrow_2d == VDEC_2D_FIL_SEL_BYPASS) ? (uint32_t)0x0000u : (uint32_t)0x0001u;
...
/**************************************************************************//**
 * @brief       Setting registers for 2D filter TAP coefficient
 * @param[in]   fil_reg_address         : 2D filter TAP coefficient registers
 * @param[in]   fil2_2d                 : 2D filter TAP coefficient parameters
 * @retval      none
 *****************************************************************************/
static void FilterTAPsCoefficient (volatile uint16_t * const * fil_reg_address, const vdec_chrfil_tap_t * const fil2_2d)
{
