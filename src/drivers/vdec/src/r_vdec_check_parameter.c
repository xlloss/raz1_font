...
* @brief        VDEC driver parameter checking functions
******************************************************************************/
...
/**************************************************************************//**
 * @brief       Checking parameters for input pin
...
/**************************************************************************//**
 * @brief       Checking parameters for active image period
...
/**************************************************************************//**
 * @brief       Checking parameters for sync separation
...
/**************************************************************************//**
 * @brief       Checking parameters for Y/C separation
...
/**************************************************************************//**
 * @brief       Checking parameters for chroma decoding
...
/**************************************************************************//**
 * @brief       Checking parameters for digital clamp
...
/**************************************************************************//**
 * @brief       Checking parameters for output adjustment
...
/**************************************************************************//**
 * @brief       Checking parameters for noise reduction LPF
...
/**************************************************************************//**
 * @brief       Checking parameters for sync slicer
...
/**************************************************************************//**
 * @brief       Checking parameters for horizontal AFC
...
/**************************************************************************//**
 * @brief       Checking parameters for vertical countdown
...
/**************************************************************************//**
 * @brief       Checking parameters for AGC / PGA
...
/**************************************************************************//**
 * @brief       Checking parameters for peak limiter control
...
/**************************************************************************//**
 * @brief       Checking parameters for Over-range control
...
/**************************************************************************//**
 * @brief       Checking parameters for Y/C separation control
...
/**************************************************************************//**
 * @brief       Checking parameters for 2D filter TAP coefficient
...
/**************************************************************************//**
 * @brief       Checking parameters for chroma decoding control
 * @param[in]   p_chrmdec_ctrl          : Chroma decoding control parameters
 * @retval      Error code
 *****************************************************************************/
static vdec_error_t ChromaDecodingControlCheckParam (const vdec_chrmdec_ctrl_t * const p_chrmdec_ctrl)
{
...
/**************************************************************************//**
 * @brief       Checking parameters for burst lock
 * @param[in]   p_burst_lock            : Burst lock parameters
 * @retval      Error code
 *****************************************************************************/
static vdec_error_t BurstLockCheckParam (const vdec_burst_lock_t * const p_burst_lock)
{
...
/**************************************************************************//**
 * @brief       Checking parameters for ACC/color killer
 * @param[in]   p_acc                   : ACC/color killer parameters
 * @retval      Error code
 *****************************************************************************/
static vdec_error_t AccColorKillerCheckParam (const vdec_acc_t * const p_acc)
{
