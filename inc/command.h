...
Macro definitions
******************************************************************************/
#define COMMAND_MAX_ARGLENGTH   (256)   /* Maximum number of characters for arguments */
#define COMMAND_MAX_LENGTH      (21)    /* Maximum number of command line string */

/* ==== cmdexe return values ==== */
