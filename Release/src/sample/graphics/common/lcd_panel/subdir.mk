...
C_SRCS += \
..\src/sample/graphics/common/lcd_panel/lcd_analog_rgb_ch0.c \
..\src/sample/graphics/common/lcd_panel/lcd_analog_rgb_ch1.c \
..\src/sample/graphics/common/lcd_panel/lcd_hdmi_ch0.c \
..\src/sample/graphics/common/lcd_panel/lcd_lcd_kit_b01_ch0.c \
..\src/sample/graphics/common/lcd_panel/lcd_lcd_kit_b01_ch1.c \
..\src/sample/graphics/common/lcd_panel/lcd_r0p7724le0011rl_ch1.c 

C_DEPS += \
./src/sample/graphics/common/lcd_panel/lcd_analog_rgb_ch0.d \
./src/sample/graphics/common/lcd_panel/lcd_analog_rgb_ch1.d \
./src/sample/graphics/common/lcd_panel/lcd_hdmi_ch0.d \
./src/sample/graphics/common/lcd_panel/lcd_lcd_kit_b01_ch0.d \
./src/sample/graphics/common/lcd_panel/lcd_lcd_kit_b01_ch1.d \
./src/sample/graphics/common/lcd_panel/lcd_r0p7724le0011rl_ch1.d 

OBJS += \
./src/sample/graphics/common/lcd_panel/lcd_analog_rgb_ch0.o \
./src/sample/graphics/common/lcd_panel/lcd_analog_rgb_ch1.o \
./src/sample/graphics/common/lcd_panel/lcd_hdmi_ch0.o \
./src/sample/graphics/common/lcd_panel/lcd_lcd_kit_b01_ch0.o \
./src/sample/graphics/common/lcd_panel/lcd_lcd_kit_b01_ch1.o \
./src/sample/graphics/common/lcd_panel/lcd_r0p7724le0011rl_ch1.o 


# Each subdirectory must supply rules for building sources it contributes
src/sample/graphics/common/lcd_panel/%.o: ../src/sample/graphics/common/lcd_panel/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/sample/graphics/common/lcd_panel/c.sub" -o "$@" "$<"
