...
C_SRCS += \
..\src/sample/graphics/common/graphics_debug.c \
..\src/sample/graphics/common/graphics_drv_wrapper.c \
..\src/sample/graphics/common/lcd_settings.c 

C_DEPS += \
./src/sample/graphics/common/graphics_debug.d \
./src/sample/graphics/common/graphics_drv_wrapper.d \
./src/sample/graphics/common/lcd_settings.d 

OBJS += \
./src/sample/graphics/common/graphics_debug.o \
./src/sample/graphics/common/graphics_drv_wrapper.o \
./src/sample/graphics/common/lcd_settings.o 


# Each subdirectory must supply rules for building sources it contributes
src/sample/graphics/common/%.o: ../src/sample/graphics/common/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/sample/graphics/common/c.sub" -o "$@" "$<"
