...
C_SRCS += \
..\src/sample/graphics/rendering/fill_color.c \
..\src/sample/graphics/rendering/image_data.c 

C_DEPS += \
./src/sample/graphics/rendering/fill_color.d \
./src/sample/graphics/rendering/image_data.d 

OBJS += \
./src/sample/graphics/rendering/fill_color.o \
./src/sample/graphics/rendering/image_data.o 


# Each subdirectory must supply rules for building sources it contributes
src/sample/graphics/rendering/%.o: ../src/sample/graphics/rendering/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/sample/graphics/rendering/c.sub" -o "$@" "$<"
