...
C_SRCS += \
..\src/sample/graphics/graphics_openvg_sample.c \
..\src/sample/graphics/video_sample.c 

C_DEPS += \
./src/sample/graphics/graphics_openvg_sample.d \
./src/sample/graphics/video_sample.d 

OBJS += \
./src/sample/graphics/graphics_openvg_sample.o \
./src/sample/graphics/video_sample.o 


# Each subdirectory must supply rules for building sources it contributes
src/sample/graphics/%.o: ../src/sample/graphics/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/sample/graphics/c.sub" -o "$@" "$<"
