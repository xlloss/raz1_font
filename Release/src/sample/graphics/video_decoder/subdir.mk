...
C_SRCS += \
..\src/sample/graphics/video_decoder/video_decoder.c 

C_DEPS += \
./src/sample/graphics/video_decoder/video_decoder.d 

OBJS += \
./src/sample/graphics/video_decoder/video_decoder.o 


# Each subdirectory must supply rules for building sources it contributes
src/sample/graphics/video_decoder/%.o: ../src/sample/graphics/video_decoder/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/sample/graphics/video_decoder/c.sub" -o "$@" "$<"
