...
C_SRCS += \
..\src/sample/sample_vdc5/sample_vdc5_cmdlist.c \
..\src/sample/sample_vdc5/sample_vdc5_common.c \
..\src/sample/sample_vdc5/sample_vdc5_main.c 

C_DEPS += \
./src/sample/sample_vdc5/sample_vdc5_cmdlist.d \
./src/sample/sample_vdc5/sample_vdc5_common.d \
./src/sample/sample_vdc5/sample_vdc5_main.d 

OBJS += \
./src/sample/sample_vdc5/sample_vdc5_cmdlist.o \
./src/sample/sample_vdc5/sample_vdc5_common.o \
./src/sample/sample_vdc5/sample_vdc5_main.o 


# Each subdirectory must supply rules for building sources it contributes
src/sample/sample_vdc5/%.o: ../src/sample/sample_vdc5/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/sample/sample_vdc5/c.sub" -o "$@" "$<"
