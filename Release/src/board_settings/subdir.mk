...
C_SRCS += \
..\src/board_settings/led.c \
..\src/board_settings/peripheral_init_basic.c \
..\src/board_settings/port_init.c \
..\src/board_settings/siochar.c \
..\src/board_settings/stb_init.c 

C_DEPS += \
./src/board_settings/led.d \
./src/board_settings/peripheral_init_basic.d \
./src/board_settings/port_init.d \
./src/board_settings/siochar.d \
./src/board_settings/stb_init.d 

OBJS += \
./src/board_settings/led.o \
./src/board_settings/peripheral_init_basic.o \
./src/board_settings/port_init.o \
./src/board_settings/siochar.o \
./src/board_settings/stb_init.o 


# Each subdirectory must supply rules for building sources it contributes
src/board_settings/%.o: ../src/board_settings/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/board_settings/c.sub" -o "$@" "$<"
