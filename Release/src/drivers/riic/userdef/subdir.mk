...
C_SRCS += \
..\src/drivers/riic/userdef/riic_userdef.c 

C_DEPS += \
./src/drivers/riic/userdef/riic_userdef.d 

OBJS += \
./src/drivers/riic/userdef/riic_userdef.o 


# Each subdirectory must supply rules for building sources it contributes
src/drivers/riic/userdef/%.o: ../src/drivers/riic/userdef/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/drivers/riic/userdef/c.sub" -o "$@" "$<"
