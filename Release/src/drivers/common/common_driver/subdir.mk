...
src/drivers/common/common_driver/%.o: ../src/drivers/common/common_driver/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/drivers/common/common_driver/c.sub" -o "$@" "$<"
