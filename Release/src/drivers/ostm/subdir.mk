...
C_SRCS += \
..\src/drivers/ostm/ostm.c \
..\src/drivers/ostm/ostm_userdef.c 

C_DEPS += \
./src/drivers/ostm/ostm.d \
./src/drivers/ostm/ostm_userdef.d 

OBJS += \
./src/drivers/ostm/ostm.o \
./src/drivers/ostm/ostm_userdef.o 


# Each subdirectory must supply rules for building sources it contributes
src/drivers/ostm/%.o: ../src/drivers/ostm/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/drivers/ostm/c.sub" -o "$@" "$<"
