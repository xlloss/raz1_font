...
C_SRCS += \
..\src/drivers/ssif/src/dma_register.c \
..\src/drivers/ssif/src/drv_ssif.c \
..\src/drivers/ssif/src/drv_ssif_user.c \
..\src/drivers/ssif/src/sample_audio_dma.c 

C_DEPS += \
./src/drivers/ssif/src/dma_register.d \
./src/drivers/ssif/src/drv_ssif.d \
./src/drivers/ssif/src/drv_ssif_user.d \
./src/drivers/ssif/src/sample_audio_dma.d 

OBJS += \
./src/drivers/ssif/src/dma_register.o \
./src/drivers/ssif/src/drv_ssif.o \
./src/drivers/ssif/src/drv_ssif_user.o \
./src/drivers/ssif/src/sample_audio_dma.o 


# Each subdirectory must supply rules for building sources it contributes
src/drivers/ssif/src/%.o: ../src/drivers/ssif/src/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/drivers/ssif/src/c.sub" -o "$@" "$<"
