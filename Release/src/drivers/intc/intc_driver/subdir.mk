...
C_SRCS += \
..\src/drivers/intc/intc_driver/intc.c \
..\src/drivers/intc/intc_driver/intc_handler.c 

C_DEPS += \
./src/drivers/intc/intc_driver/intc.d \
./src/drivers/intc/intc_driver/intc_handler.d 

OBJS += \
./src/drivers/intc/intc_driver/intc.o \
./src/drivers/intc/intc_driver/intc_handler.o 


# Each subdirectory must supply rules for building sources it contributes
src/drivers/intc/intc_driver/%.o: ../src/drivers/intc/intc_driver/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/drivers/intc/intc_driver/c.sub" -o "$@" "$<"
