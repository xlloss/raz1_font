...
C_SRCS += \
..\src/drivers/scif_uart/userdef/scif_uart_userdef.c 

C_DEPS += \
./src/drivers/scif_uart/userdef/scif_uart_userdef.d 

OBJS += \
./src/drivers/scif_uart/userdef/scif_uart_userdef.o 


# Each subdirectory must supply rules for building sources it contributes
src/drivers/scif_uart/userdef/%.o: ../src/drivers/scif_uart/userdef/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/drivers/scif_uart/userdef/c.sub" -o "$@" "$<"
