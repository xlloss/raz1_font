...
C_SRCS += \
..\src/drivers/scif_uart/scif_uart_driver/scif_uart.c 

C_DEPS += \
./src/drivers/scif_uart/scif_uart_driver/scif_uart.d 

OBJS += \
./src/drivers/scif_uart/scif_uart_driver/scif_uart.o 


# Each subdirectory must supply rules for building sources it contributes
src/drivers/scif_uart/scif_uart_driver/%.o: ../src/drivers/scif_uart/scif_uart_driver/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/drivers/scif_uart/scif_uart_driver/c.sub" -o "$@" "$<"
