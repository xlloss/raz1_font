...
C_SRCS += \
..\src/drivers/sdhi/userdef/sd_dev_dmacdrv.c \
..\src/drivers/sdhi/userdef/sd_dev_low.c 

C_DEPS += \
./src/drivers/sdhi/userdef/sd_dev_dmacdrv.d \
./src/drivers/sdhi/userdef/sd_dev_low.d 

OBJS += \
./src/drivers/sdhi/userdef/sd_dev_dmacdrv.o \
./src/drivers/sdhi/userdef/sd_dev_low.o 


# Each subdirectory must supply rules for building sources it contributes
src/drivers/sdhi/userdef/%.o: ../src/drivers/sdhi/userdef/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/drivers/sdhi/userdef/c.sub" -o "$@" "$<"
