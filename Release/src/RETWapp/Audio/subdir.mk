...
C_SRCS += \
..\src/RETWapp/Audio/AudioPlayer.c \
..\src/RETWapp/Audio/sample_main.c \
..\src/RETWapp/Audio/sample_main_cmdlist.c 

C_DEPS += \
./src/RETWapp/Audio/AudioPlayer.d \
./src/RETWapp/Audio/sample_main.d \
./src/RETWapp/Audio/sample_main_cmdlist.d 

OBJS += \
./src/RETWapp/Audio/AudioPlayer.o \
./src/RETWapp/Audio/sample_main.o \
./src/RETWapp/Audio/sample_main_cmdlist.o 


# Each subdirectory must supply rules for building sources it contributes
src/RETWapp/Audio/%.o: ../src/RETWapp/Audio/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/RETWapp/Audio/c.sub" -o "$@" "$<"
