...
C_SRCS += \
..\src/RETWapp/Audio/parser/MP3/src/parser_cmn_mp3.c \
..\src/RETWapp/Audio/parser/MP3/src/parser_data_mp3.c \
..\src/RETWapp/Audio/parser/MP3/src/parser_head_mp3.c 

C_DEPS += \
./src/RETWapp/Audio/parser/MP3/src/parser_cmn_mp3.d \
./src/RETWapp/Audio/parser/MP3/src/parser_data_mp3.d \
./src/RETWapp/Audio/parser/MP3/src/parser_head_mp3.d 

OBJS += \
./src/RETWapp/Audio/parser/MP3/src/parser_cmn_mp3.o \
./src/RETWapp/Audio/parser/MP3/src/parser_data_mp3.o \
./src/RETWapp/Audio/parser/MP3/src/parser_head_mp3.o 


# Each subdirectory must supply rules for building sources it contributes
src/RETWapp/Audio/parser/MP3/src/%.o: ../src/RETWapp/Audio/parser/MP3/src/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/RETWapp/Audio/parser/MP3/src/c.sub" -o "$@" "$<"
