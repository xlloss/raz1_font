...
C_SRCS += \
..\src/RETWapp/Audio/parser/ID3/src/parser_head_id3.c 

C_DEPS += \
./src/RETWapp/Audio/parser/ID3/src/parser_head_id3.d 

OBJS += \
./src/RETWapp/Audio/parser/ID3/src/parser_head_id3.o 


# Each subdirectory must supply rules for building sources it contributes
src/RETWapp/Audio/parser/ID3/src/%.o: ../src/RETWapp/Audio/parser/ID3/src/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/RETWapp/Audio/parser/ID3/src/c.sub" -o "$@" "$<"
