...
C_SRCS += \
..\src/RETWapp/Audio/parser/parser.c \
..\src/RETWapp/Audio/parser/parser_cmn.c \
..\src/RETWapp/Audio/parser/parser_data.c \
..\src/RETWapp/Audio/parser/parser_head.c 

C_DEPS += \
./src/RETWapp/Audio/parser/parser.d \
./src/RETWapp/Audio/parser/parser_cmn.d \
./src/RETWapp/Audio/parser/parser_data.d \
./src/RETWapp/Audio/parser/parser_head.d 

OBJS += \
./src/RETWapp/Audio/parser/parser.o \
./src/RETWapp/Audio/parser/parser_cmn.o \
./src/RETWapp/Audio/parser/parser_data.o \
./src/RETWapp/Audio/parser/parser_head.o 


# Each subdirectory must supply rules for building sources it contributes
src/RETWapp/Audio/parser/%.o: ../src/RETWapp/Audio/parser/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/RETWapp/Audio/parser/c.sub" -o "$@" "$<"
