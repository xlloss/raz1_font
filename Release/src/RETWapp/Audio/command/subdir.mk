...
C_SRCS += \
..\src/RETWapp/Audio/command/command_main.c 

C_DEPS += \
./src/RETWapp/Audio/command/command_main.d 

OBJS += \
./src/RETWapp/Audio/command/command_main.o 


# Each subdirectory must supply rules for building sources it contributes
src/RETWapp/Audio/command/%.o: ../src/RETWapp/Audio/command/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/RETWapp/Audio/command/c.sub" -o "$@" "$<"
