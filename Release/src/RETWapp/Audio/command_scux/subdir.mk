...
C_SRCS += \
..\src/RETWapp/Audio/command_scux/sample_scux.c \
..\src/RETWapp/Audio/command_scux/sample_scux_command.c 

C_DEPS += \
./src/RETWapp/Audio/command_scux/sample_scux.d \
./src/RETWapp/Audio/command_scux/sample_scux_command.d 

OBJS += \
./src/RETWapp/Audio/command_scux/sample_scux.o \
./src/RETWapp/Audio/command_scux/sample_scux_command.o 


# Each subdirectory must supply rules for building sources it contributes
src/RETWapp/Audio/command_scux/%.o: ../src/RETWapp/Audio/command_scux/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/RETWapp/Audio/command_scux/c.sub" -o "$@" "$<"
