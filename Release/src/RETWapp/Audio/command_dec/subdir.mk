...
C_SRCS += \
..\src/RETWapp/Audio/command_dec/sample_dec.c \
..\src/RETWapp/Audio/command_dec/sample_dec_command.c \
..\src/RETWapp/Audio/command_dec/sample_dec_mp3.c 

C_DEPS += \
./src/RETWapp/Audio/command_dec/sample_dec.d \
./src/RETWapp/Audio/command_dec/sample_dec_command.d \
./src/RETWapp/Audio/command_dec/sample_dec_mp3.d 

OBJS += \
./src/RETWapp/Audio/command_dec/sample_dec.o \
./src/RETWapp/Audio/command_dec/sample_dec_command.o \
./src/RETWapp/Audio/command_dec/sample_dec_mp3.o 


# Each subdirectory must supply rules for building sources it contributes
src/RETWapp/Audio/command_dec/%.o: ../src/RETWapp/Audio/command_dec/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	@arm-none-eabi-gcc -Wa,-adlhn="$(basename $(notdir $<)).lst" @"src/RETWapp/Audio/command_dec/c.sub" -o "$@" "$<"
